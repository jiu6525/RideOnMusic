  ...
  while (sortedPlaces.length < addedPlaces.value.length) {
    ...
    for (var i = 1; i < addedPlaces.value.length; i++) {
      var distance = calculateDistance(
        ...
        addedPlaces.value[i].latitude,
        addedPlaces.value[i].longitude
      );
          ...
          <div id="planner_body">
            <ul>
              <li>
                ...
                <input v-model="form.planTitle" type="text" placeholder="플랜 이름" required />
              </li>
              <li>
            ...
            <div id="buttons">
              <button
                ...
                class="btn btn-primary btn-ghost btn-open"
                @click="sortPlacesByShortestPath()"
                type="button"
              >
                최단경로로 변환하기
              </button>
            ...
            <div id="area_sel">
              ...
              >
                <div
                  v-for="place in addedPlaces.value"
                  :key="place.index"
