...
<template>
  ...
  <input type="name" class="form-control" id="floatingInput" placeholder="playlist Name" v-model="name">
  <label for="playlistName">playlist name</label>
</div>
<div class="form-floating">
  <textarea class="form-control" placeholder="Leave a comment here" id="playlist Description" v-model="description"></textarea>
  <label for="playlistDescription">playlist description</label>
</div>
          
          <div class="modal-footer mt-3">
            <div class="d-flex justify-content-center">
              <button type="button" class="btn btn-outline-success me-2 "  data-bs-dismiss="modal" @click="create" id="LOGIN">
                Create
              </button>
            </div>
          </div>
